...
package alreyesh.android.scanmarketclient.camarascan;
...
import alreyesh.android.scanmarketclient.customview.BorderedText;
 ...
 * objects.
 */
public class DetectorActivity extends CameraScanActivity implements OnImageAvailableListener {
                                ...
                                new Runnable() {
                                    ...
                                    public void run() {
                                       ...
                                       // showInference(lastProcessingTimeMs + "ms");
                                        ...
                                        ImageButton btnReconocer =  findViewById(R.id.camera_capture_button);
                                        btnReconocer.setVisibility(View.GONE);
                                        ...
                                        btnReconocer.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            tracker.fireBase(getApplicationContext());

                                              //  Toast.makeText(getApplication(),"R:"+ )
                                            }
                                        });
