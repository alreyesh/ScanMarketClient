...
public class UpdateListPurchaseDialog extends DialogFragment implements IconDialog.Callback {
            ...
            if(isValidDataForNewPurchase()){
                ...
                if(user !=null){
                    ...
                    if(name==null|| name.isEmpty()) {
                        Toast.makeText(getActivity(),"Ingrese nombre de cesta de compra",Toast.LENGTH_SHORT).show();}
                    else{
                        if(color == 0 ){
                            if(!isCreation){
